		...
		<form action="cadastrarCliente">
			...
			<div class="input">
				<input type="text" name="endereco" placeholder="endereço"
					required="required" value="${cliente.endereco }">
			</div>
			<label for="">Telefone</label>
			<div class="input">
				<input type="number" name="telefone" placeholder="telefone"
					required="required" value="${cliente.telefone }">
			</div>
			...
			<div class="">
				<select name="genero" required="required">
					...
					<option value="Masculino"
						<c:if test="${cliente.genero.equals('Masculino') }">selected</c:if>>Masculino</option>
					<option value="Feminino"
						<c:if test="${cliente.genero.equals('Feminino') }">selected</c:if>>Feminino</option>
			...
			<div class="input">
				...
				<input type="date" name="nascimento" id="valida" required="required"
					placeholder="data de nascimento"
					value="<fmt:formatDate pattern="yyyy-MM-dd" value="${cliente.nascimento.time}"/>">

			</div>
			<label for="">Produto de Interesse</label>
			<div class="input">
				<input type="text" name="produto" placeholder="Produto de Interesse"
					required="required" value="${cliente.produto }">
			</div>
			<div id="bt">
